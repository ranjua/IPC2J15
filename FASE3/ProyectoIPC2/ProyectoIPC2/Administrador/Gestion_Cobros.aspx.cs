    ...
    public partial class Gestion_Cobros : System.Web.UI.Page
    {
        ...
        private void obtenerDatos()
        {
            ...
            try
            {
                ...
                GetImpuesto();
                Txt_Comision_Porcentaje.Text = (cobro.comision.porcentaje * 100.00).ToString().Replace(',', '.');
                Txt_Peso_Cobro.Text = "" + (cobro.cobro_Libra.porcentaje).ToString().Replace(',', '.');
        ...
        public void GetImpuesto()
        {
            ...
            Txt_Impuesto_Porcentaje.Text = "" + impuesto.GetVimpuesto(Convert.ToInt32(Ddl_Tipo_Impuesto.SelectedValue));
        ...
        protected void Btn_Modificar_Click(object sender, EventArgs e)
        {
            ...
            Comision_Libra costo_lb = new Comision_Libra(double.Parse(Txt_Peso_Cobro.Text,System.Globalization.CultureInfo.InvariantCulture), Cbx_Peso_DHab.Checked);
            ...
            cobro.Actualizar_Cobro(impuesto, costo_lb, comision);
        }
